...
export default function AfricanPillarInitiative() {
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white w-full">
          ...
          >
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              transition={{ delay: 0.2, duration: 0.5 }}
              className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-lg rounded-2xl px-6 py-3 md:px-8 md:py-4 mb-8 md:mb-12 border border-white/20 shadow-2xl max-w-full mx-2"
            >
              ...
              <div className="text-left">
                <div className="text-xs md:text-sm font-semibold text-purple-200">Continental Vision</div>
                <div className="text-xs text-gray-300">African Healthcare Transformation</div>
              </div>
            </motion.div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center px-4">
              <motion.a
                ...
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="group bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-4 md:px-10 md:py-5 rounded-2xl font-bold flex items-center justify-center gap-3 md:gap-4 hover:shadow-2xl transition-all duration-300 shadow-lg w-full sm:w-auto text-sm md:text-base"
              >
                <span>Join the Movement</span>
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="group bg-white/10 backdrop-blur-lg text-white border-2 border-white/30 px-6 py-4 md:px-10 md:py-5 rounded-2xl font-bold flex items-center justify-center gap-3 md:gap-4 hover:bg-white/20 transition-all duration-300 w-full sm:w-auto text-sm md:text-base"
              >
                <span>Explore Research</span>
                <Target className="w-4 h-4 md:w-5 md:h-5 group-hover:scale-110 transition-transform" />
              </motion.a>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
              className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-3xl p-6 md:p-8 lg:p-12 h-80 md:h-96 lg:h-[500px] flex items-center justify-center relative overflow-hidden w-full"
            >
              <div className="absolute inset-0 bg-black/10"></div>
              <div className="relative text-center text-white z-10 w-full">
                <MapPin className="w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 mx-auto mb-4 md:mb-6" />
                <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 md:mb-4">Continental Reach</h3>
                <p className="text-purple-100 text-sm md:text-base lg:text-lg mb-4 md:mb-6">Partner institutions across Africa</p>
      ...
      {/* Enhanced Call to Action */}
      <section className="py-12 md:py-20 lg:py-24 bg-gradient-to-r from-purple-900 via-indigo-900 to-purple-800 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
          ...
          >
            ...
            <p className="text-base md:text-lg lg:text-xl text-purple-200 mb-8 md:mb-12 max-w-2xl mx-auto leading-relaxed px-4">
              Join us in building a continent where African innovation drives global healthcare solutions and medical sovereignty.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center px-4">
              <motion.a
                href="/contact"
                whileHover={{ scale: 1.05, y: -2 }}
                className="group bg-white text-purple-900 px-6 py-4 md:px-10 md:py-5 rounded-2xl font-bold flex items-center justify-center gap-3 md:gap-4 hover:shadow-2xl transition-all duration-300 shadow-lg w-full sm:w-auto text-sm md:text-base"
              >
                <span>Partner With Us</span>
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform" />
              </motion.a>
...
function TimelineItem({ number, title, description, icon, side, color }: { 
  ...
  return (
    <motion.div
      ...
      className={`flex items-center ${side === 'left' ? 'flex-row' : 'flex-row-reverse'} w-full`}
    >
      <div className={`flex-1 ${side === 'left' ? 'pr-4 md:pr-12 text-right' : 'pl-4 md:pl-12'}`}>
        <div className={`inline-block ${side === 'left' ? 'text-right' : 'text-left'} max-w-full`}>
          <div className={`w-12 h-12 md:w-16 md:h-16 ${colorStyles[color]} rounded-2xl flex items-center justify-center text-white font-bold text-lg md:text-xl mb-3 md:mb-4 mx-auto`}>
            {number}
          </div>
          <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-2 md:mb-3 leading-tight">{title}</h3>
          <p className="text-gray-600 text-sm md:text-base lg:text-lg leading-relaxed">{description}</p>
        </div>
      </div>
      
      <div className="relative">
        <div className={`w-6 h-6 md:w-8 md:h-8 ${colorStyles[color]} rounded-full flex items-center justify-center text-white relative z-10`}>
          {icon}
        </div>
      </div>
...
function NetworkStat({ number, title, description, color }: { 
  ...
  return (
    <motion.div
      ...
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6 }}
      className="bg-white p-4 md:p-6 lg:p-8 rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 hover:scale-105 group w-full"
    >
      <div className="text-center">
        <div className={`text-2xl md:text-3xl lg:text-4xl font-bold ${colorStyles[color]} mb-1 md:mb-2 group-hover:scale-110 transition-transform`}>
          {number}
        </div>
        <h3 className="text-base md:text-lg lg:text-xl font-bold text-gray-900 mb-2 md:mb-3 leading-tight">{title}</h3>
